...
export default function AdminDashboard({ onLogout }) {
  ...
  console.debug("[AdminDashboard] Starting load with API auth:", localStorage.getItem("ADMIN_AUTH"));
  ...
  async function loadAll() {
    try {
      ...
      const sessionsData = sessRes.sessions || [];  // api.get now returns the JSON body

      // 2) For each session, fetch QA & behavior
      ...
      // Detect a 401 in our simple fetch wrapper by looking at the message
